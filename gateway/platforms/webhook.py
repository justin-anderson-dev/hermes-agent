...
class WebhookAdapter(BasePlatformAdapter):
    ...
    async def _handle_webhook(self, request: "web.Request") -> "web.Response":
        ...
        # Build a unique delivery ID. Prefer stable provider-supplied IDs over a
        # timestamp fallback so provider retries collapse into the idempotency
        # cache instead of spawning duplicate agent runs. Svix and GitHub send a
        # delivery header; Linear sends a `webhookDeliveryId` in the body.
        delivery_id = (
